...
namespace Ogre
{
	...
	{
	public:
		DotSceneLoader() : mSceneMgr(0), m_pPhysRenderSys(0), m_pPhysScene(0), m_bPhysics(false){}
		virtual ~DotSceneLoader() {}

		void parseDotScene(const String &SceneName, const String &groupName, SceneManager *yourSceneMgr,bool physics,NxOgre::Scene* physScene=0,Critter::RenderSystem* physRenderSys=0, SceneNode *pAttachNode = NULL, const String &sPrependNode = "");
	...
	protected:
		...
		Critter::BodyDescription processBodyDescription(TiXmlElement *XMLNode, SceneNode *pParent);
		void processTrigger(TiXmlElement *XMLNode, SceneNode *pParent);
		void processSound(TiXmlElement *XMLNode, SceneNode *pParent);
		...
		Critter::RenderSystem* m_pPhysRenderSys;
